...
def generate_coverage_report():
    ...
    test_files = [
        ...
        "tests/functional/test_functional_comprehensive.py",
        "tests/regression/test_regression_comprehensive.py",
...
def main():
    ...
    # Test suites to run
    test_suites = [
        ("Unit Tests", "tests/unit/test_unit_comprehensive.py", False),
        ("Integration Tests", "tests/integration/test_integration_comprehensive.py", True),

...
def test_llm_interface():
    ...
    try:
        from llm_interface import get_available_models, get_ollama_model
...
def test_memory_system():
    """Test memory system"""
    try:
        from memory import process_memory_prompt
...
def test_main_processing():
    ...
    try:
        from main import simple_llm_process, simple_log_to_file
